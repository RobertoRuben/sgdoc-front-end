...
interface ListaDocumentosRechazadosSearchProps {
  searchTerm: string;
  ...
  selectedConfirmacion: string | undefined;
  setSelectedConfirmacion: React.Dispatch<React.SetStateAction<string | undefined>>;
  ambitos: Ambito[];
  centrosPoblados: CentroPoblado[];
  caserios: Caserio[];
}

export const ListaDocumentosRechazadosSearch: React.FC<ListaDocumentosRechazadosSearchProps> = ({
  searchTerm,
  setSearchTerm,
  selectedCaserio,
  setSelectedCaserio,
