...
import { DeleteConfirmationModal } from "@/components/modal/alerts/DeleteConfirmationModal"; // Importar el modal de confirmación
...
const RemitentesPage: React.FC = () => {
    ...
    const handleDeleteClick = (id?: number) => {
        if (id !== undefined) {
            ...
            if (remitente) {
                setSelectedRemitente(remitente);
                setIsDeleteModalOpen(true); // Abrir modal de confirmación
            }
        }
    };
    ...
    const handleDeleteConfirm = () => {
        if (selectedRemitente) {
            ...
            setIsDeleteModalOpen(false); // Cerrar modal después de confirmar
    ...
    const handleCloseModal = () => {
        setIsModalOpen(false);
        setTimeout(() => setSelectedRemitente(undefined), 300); // Asegura que el estado se restablezca después de cerrar el modal
    };
                            ...
                            {currentRemitentes.map((remitente, index) => (
                                ...
                                >
                                    ...
                                    <TableCell className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <Button
                                            onClick={() => handleDeleteClick(remitente.id)} // Cambiar para abrir el modal de confirmación
