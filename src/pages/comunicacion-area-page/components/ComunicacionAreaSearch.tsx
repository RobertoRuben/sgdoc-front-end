...
interface ComunicacionAreaSearchProps {
  searchTerm: string;
  onSearch: (e: React.ChangeEvent<HTMLInputElement>) => void;
  onClear: () => void;
}

export const ComunicacionAreaSearch: React.FC<ComunicacionAreaSearchProps> = ({
  searchTerm,
  onSearch,
  onClear,
}) => {
  ...
  return (
    <div className="relative mb-4 p-4 border-b border-gray-200">
      ...
      <Input
        ...
        id="search"
        name="search"
        placeholder="Buscar áreas de comunicación..."
        ...
        aria-label="Buscar áreas de comunicación"
        value={deferredValue}
