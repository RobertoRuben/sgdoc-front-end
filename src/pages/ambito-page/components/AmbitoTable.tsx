...
export const AmbitoTable: React.FC<AmbitoTableProps> = ({
  ambitos,
  dataVersion,
  currentPage,
  searchTerm,
  ...
  if (ambitos.length === 0) {
    return (
      <div className="w-full p-8 text-center">
        <p className="text-gray-500">No se encontraron ámbitos</p>
      </div>
    );
  }
