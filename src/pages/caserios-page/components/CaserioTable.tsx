...
export const CaserioTable: React.FC<CaserioTableProps> = ({
  caserios,
  dataVersion,
  currentPage,
  searchTerm,
  ...
  if (caserios.length === 0) {
    return (
      <div className="w-full p-8 text-center">
        <p className="text-gray-500">No se encontraron caseríos</p>
      </div>
    );
  }
