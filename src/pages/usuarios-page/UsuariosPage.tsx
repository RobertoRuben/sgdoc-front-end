...
const initialUsuarios: PaginatedUsuarioResponse = {
  data: [
    ...
    },
    {
      ...
      is_active: false,
      rol_nombre: "Administrador",
      trabajador_nombre: "Carlos López",
    },
    {
      id: 4,
      nombreUsuario: "user2",
    ...
    },
    {
      ...
      is_active: true,
      rol_nombre: "Administrador",
      trabajador_nombre: "Luis Rodríguez",
    },
    {
      id: 6,
      nombreUsuario: "user3",
...
const UsuariosPage: React.FC = () => {
  const [usuariosState, setUsuarios] =
    useState<PaginatedUsuarioResponse>(initialUsuarios);
  ...
  const usuarioDetailsToUsuario = useCallback((ud: UsuarioDetails): Usuario => {
    const rolId =
      ud.rol_nombre === "Administrador"
        ? 1
        : ud.rol_nombre === "Usuario"
        ? 2
        : 3;
    const trabajador = trabajadores.find(
      (t) => t.label === ud.trabajador_nombre
    );
  ...
  const usuarioToUsuarioDetails = useCallback(
    (u: Usuario): UsuarioDetails => {
      const rol_nombre =
        u.rolId === 1
          ? "Administrador"
          : u.rolId === 2
  ...
  const currentUsuarios = useMemo(() => {
    ...
    return filteredUsuarios.slice(
      startIndex,
      startIndex + usuariosState.pagination.pageSize
    );
  }, [
    currentPage,
    dataVersion,
      ...
      setUsuarios({
        ...
        pagination: {
          ...
          totalPages: Math.ceil(
            (usuariosState.pagination.totalItems - 1) /
              usuariosState.pagination.pageSize
          ),
        },
      });
